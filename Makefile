#
dcBIN_ALL = KEYSERVER SERVER CLIENT_ALL
cBIN_C1K = KEYSERVER CLIENT_ALL
wesBIN_C2S = SERVER CLIENT_ALL
cdfGEN_C1K = C2K_xdr.c C1K_clnt.c C1K_svc.c C1K.h
sGEN_C2S = C2S_xdr.c C2S_clnt.c C2S_svc.c C2S.h
